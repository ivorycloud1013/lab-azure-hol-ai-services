...
이미 대체된 문서에서 집어 와 근거까지 달고 자신 있게 틀린다 → ③ 틀린 걸 아무도 안 봐서
...
> 진행 방법과 지표 설명은 **[harness/README.md](harness/README.md)** 에 있습니다. 이 절은 지도입니다.
...
| `--endpoint` | (필수) | Foundry project 엔드포인트 |
| `--deployment` | `gpt-5.6-terra` | 모델 Deployment 이름 |
| `--corpus` | `assets/tools/harness/` | 질문의 근거가 되는 markdown 문서들이 있는 디렉터리 |
